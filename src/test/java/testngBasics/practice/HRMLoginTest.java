...
public void dbConnectionSetup(){
        System.out.println("--- LOGGER: Connection to data base oprmd...");
}
@AfterClass
...
// * - we can add properties/paraneters to the Test annotation itself
    @Test (enabled = false, description = "this test is WIP")// it dosent test this part
