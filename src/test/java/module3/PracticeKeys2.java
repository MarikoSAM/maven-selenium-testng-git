...
public class PracticeKeys2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        // The limitation here is that you can connect only one Keys.class + some string
        // You cannot connect 2 Keys.classes
        // searchInputBox.sendKeys(Keys.COMMAND + "a");this works
        // this will not work
        // searchInputBox.sendKeys(Keys.COMMAND + Keys.SHIFT); two keys we cannot connect
